...
* **Struktur URL Eksklusif:** Setiap studio yang berlangganan memiliki URL unik yang konsisten: `ruangtato.com/[slug]`.
...
### 4.2 Skema 11 Blok Komponen Landing Page Studio (`/[slug]`)
...
flowchart TD
    ...
    Guest -->|View Detail| LP[Studio Landing Page /:slug]
...
* **Milestone 3 (Rendering & Showcase):** Implementasi SSR Next.js untuk halaman dinamis `/[slug]`, pembuatan komponen visual untuk 11 blok, serta pengerjaan halaman direktori beranda dengan fungsi filter pencarian kota.
