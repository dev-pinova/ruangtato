...
export function H1({ className, ...props }: TypographyProps) {
  return (
    <h1
      className={cn(
        "scroll-m-20 text-5xl font-bold tracking-tighter text-foreground font-sans lg:text-7xl",
        className
      )}
      {...props}
    />
...
export function H3({ className, ...props }: TypographyProps) {
  return (
    <h3
      className={cn(
        "scroll-m-20 text-2xl font-semibold tracking-tighter text-foreground font-sans",
        className
      )}
      {...props}
    />
