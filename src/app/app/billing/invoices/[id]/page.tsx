      ...
      >
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 px-8 pt-8 pb-6 border-b border-border">
          ...
          <div className="text-left sm:text-right">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Diterbitkan: {formatDate(inv.createdAt)}
            </p>
            {inv.paidAt && (
          ...
          <table className="w-full">
            <thead>
              <tr className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">
                ...
                <th className="text-right pb-3">Jumlah</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-t border-border">
                <td className="py-4">
                  <p className="font-medium text-foreground">
                    Langganan {planInfo.name}
                  </p>
                  <p className="text-sm text-muted-foreground mt-0.5">
                    Durasi: {planInfo.duration}
                  </p>
                </td>
            ...
            <tfoot>
              <tr className="border-t-2 border-border">
                <td className="pt-4 font-bold text-foreground">Total</td>
        ...
        <div className="px-8 py-6 space-y-2.5">
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="text-foreground">IDR (Rupiah Indonesia)</span>
          </div>
        </div>
        ...
        <div className="border-t border-border px-8 py-5 bg-muted/20">
          <p className="text-xs text-muted-foreground text-center leading-relaxed">
            Invoice ini merupakan bukti transaksi digital yang sah.
            Simpan dokumen ini untuk keperluan administrasi Anda.
            Pertanyaan? Hubungi{" "}
            <a
